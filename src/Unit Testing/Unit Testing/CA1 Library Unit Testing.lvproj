	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Unit Testing" Type="Folder">
			...
			<Item Name="Type Defs" Type="Folder">
				<Item Name="Cluster2DArray.ctl" Type="VI" URL="../Typedefs/Cluster2DArray.ctl"/>
			</Item>
			<Item Name="CA1 Library" Type="Folder">
				<Item Name="Unit Testing CA1.lvlib" Type="Library" URL="../Library/Unit Testing CA1.lvlib"/>
			</Item>
			<Item Name="Test VI" Type="Folder">
				<Item Name="Files" Type="Folder">
					<Item Name="CSV Files" Type="Folder">
						<Item Name="SampleFile1.csv" Type="Document" URL="../Files/CSV Files/SampleFile1.csv"/>
						<Item Name="SampleFile2.csv" Type="Document" URL="../Files/CSV Files/SampleFile2.csv"/>
						<Item Name="SampleFile3.csv" Type="Document" URL="../Files/CSV Files/SampleFile3.csv"/>
						<Item Name="SampleFile4.csv" Type="Document" URL="../Files/CSV Files/SampleFile4.csv"/>
					</Item>
					<Item Name="Read Test Files" Type="Folder">
						<Item Name="SampleFile1.txt" Type="Document" URL="../Files/Read Test Files/SampleFile1.txt"/>
						<Item Name="SampleFile2.txt" Type="Document" URL="../Files/Read Test Files/SampleFile2.txt"/>
						<Item Name="SampleFile3.txt" Type="Document" URL="../Files/Read Test Files/SampleFile3.txt"/>
						<Item Name="SampleFile4.txt" Type="Document" URL="../Files/Read Test Files/SampleFile4.txt"/>
					</Item>
					<Item Name="Write Test Files" Type="Folder">
						<Item Name="SampleFile1.txt" Type="Document" URL="../Files/Write Test Files/SampleFile1.txt"/>
						<Item Name="SampleFile2.txt" Type="Document" URL="../Files/Write Test Files/SampleFile2.txt"/>
						<Item Name="SampleFile3.txt" Type="Document" URL="../Files/Write Test Files/SampleFile3.txt"/>
						<Item Name="SampleFile4.txt" Type="Document" URL="../Files/Write Test Files/SampleFile4.txt"/>
					</Item>
				</Item>
				<Item Name="TestVIs.lvlib" Type="Library" URL="../Test VI/TestVIs.lvlib"/>
			</Item>
		</Item>
